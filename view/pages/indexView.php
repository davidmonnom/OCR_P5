<div class="container">
    <div class="jumbotron p-3 p-md-5 text-white rounded colorRandom">
        <div class="col-md-6 px-0">
            ...
            <p class="lead my-3">David Monnom et le MVC, compliqué au début, moins à la moité et parfait à la fin.</p>
        ...
        <aside class="col-md-4 blog-sidebar">
            ...
            <div class="p-3">
                ...
                <ol class="list-unstyled">
                    <li><a target="_blank" class="linkPosts" href="https://github.com/davidmonnom/OCR_P5">GitHub</a></li>
                    <li><a target="_blank" class="linkPosts" href="https://twitter.com/monmdavid">Twitter</a></li>
                    <li><a target="_blank" class="linkPosts" href="https://www.facebook.com/monnom.david/">Facebook</a></li>
                </ol>
            </div>
        </aside><!-- /.blog-sidebar -->
